...
function sendMail_edupageCalendarUnregisterSendEmail($email, $data) {
    ...
    try {
        ...
        //Content
        $mailBody = file_get_contents(__DIR__ . "/edupageCalendarUnregisterSendEmail.html");
        ...
        */
        ...
        $altBody = file_get_contents(__DIR__ . "/edupageCalendarUnregisterSendEmail.txt");
        //$altBody = str_replace("%data%", $data['data'], $altBody);


        $mail->isHTML(true);                                  //Set email format to HTML
        $mail->Subject = $mail_config['subject_edupageCalendarUnregisterSendEmail'];
        $mail->Body    = $mailBody;
        ...
        fwrite($logfile, "\r\n". time() . "edupageCalendarUnregisterSendEmail.php - ErrorMailerError:{$mail->ErrorInfo} (e={$e})");
        fclose($logfile);
