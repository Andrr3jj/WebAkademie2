...
if (isset($_SESSION['logged_in'])) {
    ...
    $sql = "INSERT INTO texty (data, nazov, autor, autor_id, pocet_casti, product_id, stupnica, pocet_dob, pocet_riadkov, text_piesne, pata, schvalene, zobrazenia, typ, zaner, povod, kategoria, oblubene, autorska, jeModerna)
    VALUES ('$data', '$nazov', '$autor', '$autor_id','$pocet_casti', '$product_id', '$stupnica', '$pocet_dob', '$pocet_riadkov', '$text_piesne', '$pata', '$schvalene', '$zobrazenia', '$typ', '$zaner', '$povod', '$kategoria', '$oblubene', '$autorska', '$jeModerna')";
